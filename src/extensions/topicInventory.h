...
!! XXX
					self.verbose = self.topic.verbose;
					...
					!! Ahora la acción ##NPCTalk toma el control para mostrar 
...
!!==============================================================================
!!	Definición de gramática y acción de apoyo que se lanzan si se reconoce en 
!!	la entrada de usuario un intento de seguir con alguno de los temas de la 
!!	conversación activa en el gestor
!!------------------------------------------------------------------------------
...
[ NPCTalkSub;
	...
	if (child(TagConversationSystem.current_conversation) ~= nothing) {
		if (TagConversationSystem.verbose) {
			new_line;
